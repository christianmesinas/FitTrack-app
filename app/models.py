...
class CalendarEvent(db.Model):
    """
    Model voor kalender gebeurtenissen in de FitTrack-applicatie.
    """
    ...
    recurrence_pattern: so.Mapped[Optional[str]] = so.mapped_column(sa.String(50), nullable=True)  # daily, weekly, monthly
